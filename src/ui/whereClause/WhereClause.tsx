...
const presets: Array<SchemaButtonPreset> = [
    {
        ...
        schema: "CREATE TABLE user(ID INT PRIMARY KEY, NAME TEXT, AGE INT); INSERT INTO user(ID, NAME, TEXT) VALUES(0, 'Kacper', 20); INSERT INTO user(ID, NAME, TEXT) VALUES(0, 'Mateusz', 15); INSERT INTO user(ID, NAME, TEXT) VALUES(3, 'Oskar', 13); INSERT INTO user(ID, NAME, AGE) VALUES(2, 'Karolina', 17);",
        text: "Pełnoletni użytkownicy"
    },
    {
        query: "SELECT * FROM kot WHERE NAME IS NOT NULL;",
        schema: "CREATE TABLE kot(ID INT PRIMARY KEY, NAME TEXT); INSERT INTO kot(ID, NAME) VALUES(1, 'Puszek'); INSERT INTO kot(ID, NAME) VALUES(2, NULL); INSERT INTO kot(ID, NAME) VALUES(2, 'Kot we butach')",
